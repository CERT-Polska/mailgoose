...
TRANSLATIONS = {
    ...
    Language.pl_PL: [  # type: ignore
        ...
        (
            ...
            "oznacza, że ustawienie DMARC nie będzie skuteczne. Ustawienie 'rua' nie wpływa na mechanizm blokowania, ale "
        ...
        (
            ...
            "should be ≤ 255 characters (RFC 7208 § 3.3). Consider splitting it into multiple quoted strings.",  # yes, there's a space at the beginning of the message
